...
class FSDPWorker(Worker):
    def __init__(
        ...
        if self._is_actor:
            ...
            print ('Actor info here', 'actor.global_batch_size_per_device', self.config.actor.global_batch_size_per_device, 'device mesh', self.device_mesh, 'ulysses_sequence_parallel_size', self.ulysses_sequence_parallel_size, 'micro_batch_size_per_device_for_update', self.config.actor.micro_batch_size_per_device_for_update)
        elif self._is_critic:
